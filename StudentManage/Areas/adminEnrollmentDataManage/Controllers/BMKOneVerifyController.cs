...
namespace StudentManage.Areas.adminEnrollmentDataManage.Controllers
{
    ...
    public class BMKOneVerifyController : TreeSelMasterController
    {

        public BMKOneVerifyController()
        {
            sAreaName = "adminEnrollmentDataManage";
            sPageKeyWord = "BMKOneVerify";
        ...
        public override void SetInitDataAuthor()
        {
            ...
            SetHiddenValue(sDataListName + "_InitValues", sGxID + CosValue.SPLITOPERATOR1.ToString() + "未审核,一次审核");
        ...
        public ActionResult BMKOneVerify_SelectMzdmChange(string PanelID, string sSelID)
        {
            SetHiddenValue(sPageKeyWord + "_SearchMzdmID", sSelID);
            return this.Direct();
        }
        public ActionResult BMKOneVerify_SelectXbdmChange(string PanelID, string sSelID)
        {
            SetHiddenValue(sPageKeyWord + "_SearchXbdmID", sSelID);
            return this.Direct();
        }
        public ActionResult BMKOneVerify_SelectZzmmdmChange(string panelID,string sSelID)
        {
            SetHiddenValue(sPageKeyWord + "_SearchZzmmdmID", sSelID);
            return this.Direct();
        }
        public ActionResult BMKOneVerify_SelectKslbdmChange(string panelID, string sSelID)
        {
            SetHiddenValue(sPageKeyWord + "_SearchKslbdmID", sSelID);
            return this.Direct();
        }

        public ActionResult BMKOneVerify_SelectBylbdmChange(string panelID, string sSelID)
        {
            SetHiddenValue(sPageKeyWord + "_SearchBylbdmID", sSelID);
            return this.Direct();
        }
        public ActionResult BMKOneVerify_SelectKslxdmChange(string panelID, string sSelID)
        {
            SetHiddenValue(sPageKeyWord + "_SearchKslxdmID", sSelID);
            return this.Direct();
        }

        public ActionResult BMKOneVerify_SelectWyyzdmChange(string panelID, string sSelID)
        {
            SetHiddenValue(sPageKeyWord + "_SearchWyyzdmID", sSelID);
            return this.Direct();
        }

        public ActionResult BMKOneVerify_SelectByxxdmChange(string panelID, string sSelID)
        {
            SetHiddenValue(sPageKeyWord + "_SearchByxxdmID", sSelID);
            return this.Direct();
        }
        public ActionResult BMKOneVerify_SelectDqdmChange(string panelID, string sSelID)
        {
        ...
        public override ActionResult DataList_ReturnAddClick(string PanelID, string selection, string keywords, string transvalue)
        {
            ...
            man.FirstVerifyRecords(manDataList.sRowAllIDs);
            RefreashDataList(sDataListName);
            return this.Direct();
        }

        [DirectMethod]
        public ActionResult BMKOneVerify_SearchClickDirectMethod(string sData)
        {
