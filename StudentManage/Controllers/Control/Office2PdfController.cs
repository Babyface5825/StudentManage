...
namespace StudentManage.Controllers
{
    public class Office2PdfController 
    {
        ...
        //    dynamic application = new PowerPoint.ApplicationClass();
        //    dynamic persentation = application.Presentations.Open(sourcePath, MsoTriState.msoTrue, MsoTriState.msoFalse, MsoTriState.msoFalse);
        //    try
        //    {
